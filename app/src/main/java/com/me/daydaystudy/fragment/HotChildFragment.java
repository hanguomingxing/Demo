...
import com.me.daydaystudy.adapter.TopicAdapter;
...
public class HotChildFragment extends BaseFragment implements SpringView.OnFreshListener {
    ...
    protected void init() {
        super.init();
        initView();
        topicAdapter = new TopicAdapter(getActivity(), R.layout.hot_recycler_item, contentList);
        hot_child_recyclerView.setAdapter(topicAdapter);
        //初始化请求
